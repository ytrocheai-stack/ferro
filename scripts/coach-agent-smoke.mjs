...
if (!has('--execute')) {
  ...
  const headers = { Authorization: `Bearer ${token}`, Origin: origin, 'Content-Type': 'application/json', 'X-NextRep-Consent-Version': 'coach-context-v3-gemini-nvidia', 'X-NextRep-Device-Id': deviceId }
  let requests = 0
