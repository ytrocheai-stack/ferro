# Informe T0 — restricciones y estado del proveedor
...
- Se inventariaron referencias locales a proveedores, modelos, flags, Clerk y
  ...
  privados.
- Se revisó el diff final para confirmar que solo incluye `docs/DESPLIEGUE.md`,
  `worker/README.md` y este informe.
